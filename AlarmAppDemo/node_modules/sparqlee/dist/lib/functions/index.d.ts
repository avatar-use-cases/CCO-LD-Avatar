...
import { NamedFunction, RegularFunction, SpecialFunction } from './FunctionClasses';
...
export declare type SpecialFunctionAsyncMap = Map<C.SpecialOperator, SpecialFunction>;
