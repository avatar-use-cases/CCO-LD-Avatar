const __b15bnode111 = new (require('@comunica/logger-void').LoggerVoid)({});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_dereference_paged_Bus_RdfDereferencePaged = new (require('@comunica/core').Bus)({
...
const __b0bnode275 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': '_:b0bnode275',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize_Bus_RdfSerialize
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_mediatorRdfResolveHypermedia = new (require('@comunica/mediator-race').MediatorRace)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_mediatorRdfDereferencePaged = new (require('@comunica/mediator-race').MediatorRace)({
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_myRdfMetadataTriplePredicate = new (require('@comunica/actor-rdf-metadata-triple-predicate').ActorRdfMetadataTriplePredicate)({
  'predicateRegexes': [
...
const cbrrqp_Actor_RdfResolveQuadPattern_httpInvalidator_default = new (require('@comunica/bus-http-invalidate').ActorHttpInvalidateListenable)({
...
const __b0bnode269 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': '_:b0bnode269',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_resolve_hypermedia_json_myRdfPagedDereferencer = new (require('@comunica/actor-rdf-dereference-paged-next').ActorRdfDereferencePagedNext)({
