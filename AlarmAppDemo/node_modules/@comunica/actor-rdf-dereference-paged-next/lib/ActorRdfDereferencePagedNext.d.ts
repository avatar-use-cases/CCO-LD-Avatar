...
import { ActorRdfDereferencePaged, IActionRdfDereferencePaged, IActorRdfDereferencePagedOutput } from "@comunica/bus-rdf-dereference-paged";
...
export declare class ActorRdfDereferencePagedNext extends ActorRdfDereferencePaged implements IActorRdfDereferencePaged {
    ...
    readonly cache: LRU.Cache<string, Promise<IActorRdfDereferencePagedOutput>>;
